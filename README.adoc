...
image:https://travis-ci.org/vert-x3/vertx-circuit-breaker.svg?branch=master?branch=master["Build Status",link="https://travis-ci.org/vert-x3/vertx-circuit-breaker"]
