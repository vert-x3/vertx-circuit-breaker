...
In order to mitigate this problem it is recommended to execute retries with delays. {@link io.vertx.circuitbreaker.CircuitBreaker#retryPolicy(java.util.function.Function)}
